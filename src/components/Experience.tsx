...
import { Download, Code, Database, Plane, Users, BarChart3, Cloud, Brain, Settings, Target } from "lucide-react";
    ...
    <section className="px-8 py-16 max-w-7xl mx-auto">
      <div className="mb-12 text-center">
        ...
        <p className="text-gray-600 text-lg max-w-2xl mx-auto">
          A decade of expertise in aviation data analytics, backed by cutting-edge tools and proven methodologies
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-12">
        ...
        <div className="lg:col-span-2 bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 text-white relative overflow-hidden group">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-lime-400 mb-6">Driving Aviation Data Solutions</p>
            <div className="space-y-3 mb-8">
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-lime-400 rounded-full"></div>
                <span className="text-gray-300">500+ ML models deployed in production</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-lime-400 rounded-full"></div>
                <span className="text-gray-300">150+ airlines served globally</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-2 h-2 bg-lime-400 rounded-full"></div>
                <span className="text-gray-300">99.9% system uptime achieved</span>
              </div>
            </div>
        ...
        <div className="bg-lime-400 rounded-2xl p-6 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="text-sm text-black/80 font-medium mb-3">Workshops Delivered</div>
            <div className="text-2xl font-bold text-black mb-1">50+</div>
            <div className="text-sm text-black/80 font-medium">Patents Filed</div>
          </div>
        </div>
      ...
      {/* Tools We Use Daily */}
      <div>
        <h3 className="text-2xl font-bold text-gray-900 mb-6">Tools We Use Daily</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
          {tools.map((tool, index) => (
            <div key={index} className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300 group cursor-pointer relative">
